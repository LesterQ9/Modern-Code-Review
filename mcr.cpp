...
bool isWin(char game[3][3]) {
    ...
    if (game[1][0] == game[0][1] && game[1][1] == game[1][2] && (game[1][0] == 'X' || game[1][0] == 'O')) win = true;
    if (game[2][0] == game[0][1] && game[2][1] == game[2][2] && (game[2][0] == 'X' || game[2][0] == 'O')) win = true;
    // column
...
int main() {
    ...
    if (i==3)  // all cells have been inputted above but no winner yet
        cout << "Tie!" << endl;
